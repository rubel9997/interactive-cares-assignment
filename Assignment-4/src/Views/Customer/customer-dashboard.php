...
$balance = (new DashboardController())->getBalance($user_id);
$transaction_list = (new DashboardController())->getTransactionList($user_id);
                                ...
                                <table class="min-w-full divide-y divide-gray-300">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <?php
                                            if($value['transaction_type'] == \App\TransactionType::DEPOSIT || $value['transaction_type'] == \App\TransactionType::RECEIVE){
                                                 ?>
                                                ...
                                                <?php
                                            }elseif($value['transaction_type'] == \App\TransactionType::WITHDRAW || $value['transaction_type'] == \App\TransactionType::TRANSFER){
                                                  ?>
