        ...
        <section
            ...
            <div
                ...
                <div class="flex flex-col justify-center items-center">
                    <h4 class="sm:text-xl font-bold">{{ count($user->posts) ?? '0'  }}</h4>
        ...
        <form
            ...
            <div>
              ...
              <textarea
                  ...
                  name="description"
                  rows="2"
                  placeholder="What's going on, {{$user->first_name}}?"></textarea>
                    </div>
                </div>
            </div>
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div class="text-gray-900 flex flex-col min-w-0 flex-1">
                                <a
                                    ...
                                    {{$post->user->first_name.' '.$post->user->last_name ?? "Mr.Alex"}}
                                </a>
                                <a
                                    href="{{route('profile',$post->user->username)}}"
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex gap-8 text-gray-600">
                            ...
                            <button
                                ...
                                @php $react_check = \App\Helper\Helper::reactCheck($post->id); @endphp
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
